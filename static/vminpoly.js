    ...
    (function() {
      ...
      ajax = function(url, onload) {
        ...
        try {
          ...
          e = _error;
          console.log(
            'ERROR: ' + e.message + ' (' + e.type + ') when accessing ' + url
          );
        }
      };
      ...
      browserSupportsUnitsNatively = function() {
        ...
        test_results =
          testVWSupport(test_element, style_block) &&
          testVWSupport(test_element, style_block) &&
          testVMinSupport(test_element, style_block);
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              ...
              for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                ...
                if (
                  ...
                  ruleCss +=
                    '' + Math.floor(token.num * dims[token.unit]) + 'px';
                } else {
                    ...
                    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                      ...
                      if (t.name === '(') {
                        ...
                        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                          t1 = _ref2[_k];
                          source =
                            t1.toSourceString != null
                              ? t1.toSourceString()
                              : '';
                          if (
                            t1.tokenType === 'IDENT' &&
                            source === 'max-aspect-ratio'
                          ) {
                            mar = true;
                          }
